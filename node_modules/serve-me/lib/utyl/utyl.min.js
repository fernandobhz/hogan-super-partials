...
var RGBA=function(a,b,c,d){this.set(a,b,c);this.alpha=d};RGBA.inherits(RGB);Math.randomRange=function(a,b){return Math.floor(Math.random()*(b-a))+a};Timer=function(a,b,c){function d(){if(!(e.times&&h++>=e.times)){f=(new Date).getTime();var b=f-last-g;0>b&&(b=0);last=f;a(b/g+1)||setTimeout(d,g-b)}}var e=this;e.times=c;var g=1E3/b,h=0,f=0;setTimeout(function(){last=(new Date).getTime();d()},0)};Timer.prototype.close=function(){this.times=!0};"undefined"!=typeof document&&(document.host=document.URL.split("/")[2].split(":")[0]);